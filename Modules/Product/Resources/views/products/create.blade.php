            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_name">Nombre de Producto <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="barcode_symbology">Simbología de código de barras <span class="text-danger">*</span></label>
                                        <select class="form-control" name="product_barcode_symbology" id="barcode_symbology" required>
                                            <option value="" selected disabled>Seleccionar Simbología</option>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Alertar de Cantidad <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            ...
                                            <option value="2">Incluido</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">Unidad <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Este texto breve se colocará después de la Cantidad del Producto."></i> <span class="text-danger">*</span></label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="image">Imagenes del Producto <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Archivos Máximos: 3, Tamaño Máximo de Archivo: 1MB, Tamaño de Imagen: 400x400"></i></label>
