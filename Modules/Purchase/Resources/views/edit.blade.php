                        ...
                        <form id="purchase-form" action="{{ route('purchases.update', $purchase) }}" method="POST">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $purchase->status == 'Pending' ? 'selected' : '' }} value="Pending">Pendiente</option>
                                            <option {{ $purchase->status == 'Ordered' ? 'selected' : '' }} value="Ordered">Ordernado</option>
                                            <option {{ $purchase->status == 'Completed' ? 'selected' : '' }} value="Completed">Completado</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Actualizar Pago <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
