...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('quotations.index') }}">Cotización</a></li>
                        ...
                        <form id="quotation-form" action="{{ route('quotations.update', $quotation) }}" method="POST">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $quotation->status == 'Pending' ? 'selected' : '' }} value="Pending">Pendiente</option>
                                            <option {{ $quotation->status == 'Sent' ? 'selected' : '' }} value="Sent">Envíado</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Actualizar Cotizaciones <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
