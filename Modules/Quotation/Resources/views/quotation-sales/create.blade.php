...
@section('title', 'Crear venta a partir de cotización')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('quotations.index') }}">Cotizaciones</a></li>
        <li class="breadcrumb-item active">Hacer Venta</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form id="sale-form" action="{{ route('sales.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">Monto Recibo <span class="text-danger">*</span></label>
