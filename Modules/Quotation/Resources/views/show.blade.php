                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                <h5 class="mb-2 border-bottom pb-2">Información del Recibo:</h5>
                                <div>Recibo: <strong>INV/{{ $quotation->reference }}</strong></div>
                                <div>Fecha: {{ \Carbon\Carbon::parse($quotation->date)->format('d M, Y') }}</div>
                                <div>
                                    Estado: <strong>{{ $quotation->status }}</strong>
                                </div>
                                <div>
                                    Estado del Pago: <strong>{{ $quotation->payment_status }}</strong>
                                </div>
                            </div>
