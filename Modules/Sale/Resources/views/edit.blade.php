                        ...
                        <form id="sale-form" action="{{ route('sales.update', $sale) }}" method="POST">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $sale->status == 'Pending' ? 'selected' : '' }} value="Pending">Pendiente</option>
                                            <option {{ $sale->status == 'Shipped' ? 'selected' : '' }} value="Shipped">Enviado</option>
                                            <option {{ $sale->status == 'Completed' ? 'selected' : '' }} value="Completed">Completado</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Actualizar venta <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
