    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <p class="font-italic">Cambie la información de su perfil y contraseña desde aquí...</p>
            </div>
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.update.password') }}" method="POST">
                            ...
                            @method('patch')
                            <div class="form-group">
                                <label for="current_password">Password Actual <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="password">Nuevo Password <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary">Actualizar Password  <i class="bi bi-check"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
