                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_total_stats">Estadísticas totales</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_notifications">Notificaciones</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_month_overview">Resumen del mes</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_weekly_sales_purchases">
                                                            Ventas y compras semanales
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_monthly_cashflow">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_products">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="edit_products">Editarar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_adjustments">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="edit_adjustments">Editarar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_quotations">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="edit_quotations">Editarar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="create_quotation_sales">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="edit_expenses">Editarar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="delete_expenses">Eliminar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_customers">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_suppliers">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_sales">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_sale_returns">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_purchases">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_purchase_returns">Mostrar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
