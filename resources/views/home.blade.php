    ...
    <div class="container-fluid">
                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="text-muted text-uppercase font-weight-bold small">Ingreso</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="text-muted text-uppercase font-weight-bold small">Devolución de ventas</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="text-muted text-uppercase font-weight-bold small">Devolución de compras</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header">
                        Descripción general de {{ now()->format('F, Y') }}
                    </div>
